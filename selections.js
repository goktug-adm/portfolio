...
//
//  These are the curated highlights shown in the sidebar of each
//  project's detail page. The big bottom gallery always shows the full
//  report (every PDF page render). If a slug has no entry here, the
//  sidebar falls back to whatever custom images you uploaded for that
//  project. Empty everywhere → no sidebar mini-gallery.
//
//  Edit via picker.html → ⬇ Download / ⬆ Push.
// =====================================================================
window.SELECTIONS = {
